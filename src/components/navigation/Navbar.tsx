...
export default function Navbar() {
  ...
  const [showMobileDienstenDropdown, setShowMobileDienstenDropdown] =
	useState(false);
			  ...
			  >
				...
				<ChevronDown
				  className={`ml-1 w-4 h-4 transition-transform ${
					showDienstenDropdown ? "rotate-180" : ""
				  }`}
				/>
			  </button>
		...
		{isOpen && (
		  ...
		  >
			...
			>
			  <button
				onClick={() =>
				  setShowMobileDienstenDropdown(!showMobileDienstenDropdown)
				}
			  ...
			  >
				...
				<ChevronDown
				  className={`ml-1 w-4 h-4 transition-transform ${
					showMobileDienstenDropdown ? "rotate-180" : ""
				  }`}
				/>
			  </button>
